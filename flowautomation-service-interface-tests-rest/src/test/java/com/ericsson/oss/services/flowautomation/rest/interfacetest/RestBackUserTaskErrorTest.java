...
import com.ericsson.oss.services.flowautomation.interfacetest.BackUserTaskErrorTest;
import com.ericsson.oss.services.flowautomation.test.fwk.TestClientType;

@RunAsClient
@RunWith(Arquillian.class)
public class RestBackUserTaskErrorTest extends BackUserTaskErrorTest {
    @Override
