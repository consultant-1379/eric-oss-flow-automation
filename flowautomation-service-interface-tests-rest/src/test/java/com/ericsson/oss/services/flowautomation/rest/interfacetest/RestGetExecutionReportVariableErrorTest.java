...
import com.ericsson.oss.services.flowautomation.interfacetest.GetExecutionReportVariableErrorTest;
import com.ericsson.oss.services.flowautomation.test.fwk.TestClientType;

@RunAsClient
@RunWith(Arquillian.class)
public class RestGetExecutionReportVariableErrorTest extends GetExecutionReportVariableErrorTest {
    @Override
