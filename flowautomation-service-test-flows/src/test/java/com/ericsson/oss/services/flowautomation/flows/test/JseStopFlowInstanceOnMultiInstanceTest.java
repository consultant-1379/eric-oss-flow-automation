...
/**
 * The type Jse stop flow instance on multi instance test.
 */
public class JseStopFlowInstanceOnMultiInstanceTest extends DslStopFlowInstanceOnMultiInstanceTest {
    @Override
