...
/**
 * Test cases for Flow Without Setup phase using Flow Automation Service API via JSE using a simple DSL.
 */
public class JseDslFlowWithoutSetupTest extends DslFlowWithoutSetupTest {
