...
/**
 * JSE Test cases for for testing the usertask input validation in a scripttask.
 */
public class JseApiUsertaskValidationTest extends ApiUsertaskValidationTest {
