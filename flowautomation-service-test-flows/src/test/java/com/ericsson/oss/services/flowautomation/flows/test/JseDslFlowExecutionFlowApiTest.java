...
/**
 * Test cases for Flow With Setup phase using Flow Automation Service API via JSE using a simple DSL.
 */
public class JseDslFlowExecutionFlowApiTest extends DslFlowExecutionFlowApiTest {
