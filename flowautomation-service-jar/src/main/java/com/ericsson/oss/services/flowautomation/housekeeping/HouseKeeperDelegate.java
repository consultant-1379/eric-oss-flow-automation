...
/**
 * The Class HouseKeeperDelegate.
 */
public class HouseKeeperDelegate implements JavaDelegate {

    private static final Logger LOGGER = LoggerFactory.getLogger(HouseKeeperDelegate.class);

    @Override
    public void execute(final DelegateExecution execution) throws Exception {
        LOGGER.debug("Executing House Keeping...");
        ...
        houseKeeperInternal.performHouseKeeping(retentionPeriod, retentionPeriodTimeUnit);
    }
}
