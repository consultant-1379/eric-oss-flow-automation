...
/**
 * The type House keeping historic stopped instances delegate.
 */
public class HouseKeepingHistoricStoppedInstancesDelegate implements JavaDelegate {

    private static final Logger LOGGER = LoggerFactory.getLogger(HouseKeepingHistoricStoppedInstancesDelegate.class);

    @Override
    public void execute(final DelegateExecution execution) throws Exception {
        LOGGER.debug("Cleaning up historic stopped flow instances...");
        ...
        houseKeeperInternal.cleanHistoricStoppedFlowInstances(retentionPeriod, retentionPeriodTimeUnit);
    }
}
