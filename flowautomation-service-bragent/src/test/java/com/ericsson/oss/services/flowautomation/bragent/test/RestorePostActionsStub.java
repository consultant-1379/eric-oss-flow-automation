...
public class RestorePostActionsStub extends PostRestoreActions {

    private boolean successful;
    private String message;

    public RestorePostActionsStub(){
        super(null,null);
    }

    public RestorePostActionsStub(Agent agent, RestoreInformation restoreInformation) {
