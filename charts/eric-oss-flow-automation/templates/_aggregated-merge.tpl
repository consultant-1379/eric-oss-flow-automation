...
*/ -}}
{{- define "eric-oss-flow-automation.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-flow-automation.mergeAnnotations" -}}
  {{- include "eric-oss-flow-automation.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-flow-automation.mergeLabels" -}}
  {{- include "eric-oss-flow-automation.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
